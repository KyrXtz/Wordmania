namespace Gravitons.UI.Modal
{
    ...
    public class DemoManager : MonoBehaviour
    {
        ...
        {
            ModalManager.Show("Modal Title", "Show your message here",null, new[] { new ModalButton() { Text = "OK" } });
        }
        ...
        {
            ModalManager.Show("Change Background Color", "Change background color to a random color",null,
