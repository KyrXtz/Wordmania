...
namespace Gravitons.UI.Modal
{
    ...
    public class ModalManager : MonoBehaviour
    {
        ...
        private static Modal lastActiveModal;
        ...
        public static Modal Show(string title, string body, Sprite sprite, ModalButton[] buttons)
        {
            Close();
            return Instance.InternalShow(Instance.m_DefaultIdentifier, new GenericModalContent(){ Title = title, Body = body,Sprite = sprite } , buttons);
        }
        ...
        {
            if (lastActiveModal != null)
            {
                lastActiveModal.Close();
                lastActiveModal = null;
            }
            else
            {
                Debug.LogWarning("No Modal to close.");
